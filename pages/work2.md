...
<div class="textbox2">
            <div class="main-content">
                ...
                <li>Statistical and dynamical study of anomalous electrical properties of semiconductors under thermodynamic fluctuation and with magnetic impurities.</li>
                 <li style="font-family: 'Avenir Next LT Pro'; font-weight: normal; font-size: 14px; color: gray; margin-top: 20px;padding-bottom: 20px;">IPM : Institute for Research in Fundamental Sciences, Tehran</li>
                </ul>
            ...
            <div class="additional-column">
                ...
                <span class="location" style="margin-left: -15px; margin-top: 20px;">IPM</span>
            </div>
        </div>
        <br>
