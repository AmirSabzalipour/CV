...
<div class="textbox" style="display: flex;">
    ...
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 1px;"> <p style="font-size: 22px;  color: #3d5a80; padding_bottom:10; margin-left: 10px;">I.   Postdoctoral Researcher</p>
        </div>
    ...
    <div style="::before; content: ''; position: absolute; top: 45px; left: 10px; width: 98%; height: 5px; background: linear-gradient(to right, rgba( 33, 113, 181, 0.3) 80%, rgba(212, 156, 74,1)  20%); 
