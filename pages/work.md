...
<div class="textbox" style="display: flex;">
    ...
    <div style="::before; content: ''; position: absolute; top:-7px; left: 0; width: 100%; height: 5px; background: linear-gradient(to right, rgba( 13, 152, 186,.8) 78%, rgba(212, 156, 74,1)  22%); 
