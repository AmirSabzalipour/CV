...
<section>
<div class="textbox" style="display: flex;justify-content: space-between; background-color:  rgba(120, 144, 156, 0.2);line-height: 40px; margin-bottom: 5px;">
...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: 10px;">
    ...
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 5px;"> <p style="font-size: 20px;color:  #color: rgba(46, 89, 132,1);font-family: 'Garamond'; margin-left: 4px;">I.   Postdoctoral Researcher</p>
        </div>
