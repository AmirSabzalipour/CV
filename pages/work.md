...
<div class="textbox" style="display: flex;">
    ...
    <div style="::before; content: ''; position: absolute; top:-7px; left: 0; width: 100%; height: 6px; background: linear-gradient(to right, rgba( 13, 152, 186,.8) 78%, rgba(212, 156, 74,1)  22%); 
...
<div class="textbox" style="display: flex;">
    <div class="main-content" style="flex: 1;">
      ...
      <li>Atomic Force Microscopy characterization of thin films.</li>
        ...
        <div style="::before; content: ''; position: absolute; top: -7px; left: 0; width: 100%; height: 8px; background: linear-gradient(to right, rgba(33, 113, 181, 0.3) 78%, rgba(102, 77, 85,.6) 22%); 
        border-radius: 20px 20px 20px 20px;"> </div>
        </div>
   <div class="additional-column" style=" padding-top: 19px; width: 160px;height: 100px;">
   <p><span style="font-family: 'Avenir Next LT Pro'; font-size: 15px; color: gray;"> </span></p>
