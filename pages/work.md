...
<div class="textbox" style="display: flex;">
    ...
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 1px;"> <p style="font-size: 21px;  color: navy; margin-left: 10px;">I.   Postdoctoral Researcher</p>
        </div>
