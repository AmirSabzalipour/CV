...
<div class="textbox" style="display: flex;">
    ...
    <div style="::before; content: ''; position: absolute; top:-7px; left: 0; width: 100%; height: 9px; background: linear-gradient(to right, rgba(33, 113, 181, 0.6) 78%, rgba(234, 106, 71, .6) 22%); 
