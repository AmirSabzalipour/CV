...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: 10px;">
    ...
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 0px;"> <p style="font-weight: bold; font-size: 21px; color: rgba(61, 90, 128,1); font-family: 'Garamond'; margin-left: .9em;"> Postdoctoral Researcher</p>
        </div>
