...
<div class="textbox" style="display: flex;">
    <div class="main-content" style="flex: 1;">
        ...
        <div style="::before; content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 8px; background: linear-gradient(to right, rgba(115, 147, 179, 0.6) 76%, rgba(99, 119, 91, 0.9) 24%); 
