...
<div class="textbox" style="display: flex;">
    ...
    <div style="::before; content: ''; position: absolute; top: 10; left: 0; width: 100%; height: 9px; background: linear-gradient(to right, rgba(33, 113, 181, 0.6) 78%, rgba(121, 178, 77, .6) 22%); 
