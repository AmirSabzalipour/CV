...
<style>
        ...
        .textbox {
            background-color: rgba(126, 144, 154, 0.3);
...
<div class="textbox" style="display: flex;">
   ...
   <div class="additional-column" style="background-color: #f6f6f6;  margin-top: 30px; width: 160px;height: 100px;border-radius: 10px;">
