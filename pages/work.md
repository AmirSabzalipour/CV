...
<div class="textbox" style="display: flex;">
    ...
    <div style="::before; content: ''; position: absolute; top: 200px; left: 0; width: 100%; height: 7px; background: linear-gradient(to right, rgba( 33, 113, 181, 0.3) 78%, rgba(212, 156, 74,1)  22%); 
