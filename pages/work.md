...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: 10px;">
    ...
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 5px;"> <p style=" font-weight: bold; font-family: 'Garamond'; font-size: 21px; color: rgba(62,121,180,1);margin-left: .9em;"> Postdoctoral Researcher</p>
        </div>
    ...
    <li style="margin-bottom: 10px;">Developing computational models to optimize energy loss in quantum topological materials, incorporating statistical, electrical, quantum and topological features.</li>
     ...
     <div style="::before; content: ''; position: absolute; top: 47px; left:0px; width: 98%; height: 2.5px; background: linear-gradient(to right, rgba(62,121,180,.6)  79.5%, rgba(200,144,98,1)  20.5%); 
...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: 10px;">
    <div class="main-content" style="flex: 1;">
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 5px;"> <p style=" font-weight: bold; font-family: 'Garamond'; font-size: 21px; color: rgba(62,121,180,1);margin-left: .9em;"> Doctoral Researcher</p>
        </div>
    <ul style="font-size: 15px; font-family: 'AvenirNext LT Pro Regular', sans-serif; margin-left: 1.7em; color: black;">
...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: 10px;">
    <div class="main-content" style="flex: 1;">
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 5px;"> <p style="font-weight: bold; font-family: 'Garamond';  font-size: 21px; color: rgba(62,121,180,1);margin-left: 0.9em;"> Visiting Researcher</p>
        </div>
    <ul style="font-size: 15px; font-family: 'AvenirNext LT Pro Regular', sans-serif; margin-left: 1.7em; color: black;">
...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: -20px;">
    <div class="main-content" style="flex: 1;">
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 5px;"> <p style="font-weight: bold; font-family: 'Garamond'; font-size: 21px; color: rgba(62,121,180,1);margin-left: 0.9em;">Research Engineer</p>
        </div>
...
<div class="textbox" style="display: flex;justify-content: space-between;  line-height: 90px; margin-bottom: 10px;">
    <div class="main-content" style="flex: 1;">
        <div style="margin-left: 0em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 9px;"> <p style="font-weight: bold; font-family: 'Garamond'; font-size: 21px; color: rgba(62,121,180,1);margin-left: 0.9em;">Optical Design Engineer</p>
        </div>
...
<div class="textbox" style="display: flex;">
    <div class="main-content" style="flex: 1;">
        <div style="margin-left: 0em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 9px;"> <p style="font-weight: bold; font-family: 'Garamond'; font-size: 21px; color: rgba(62,121,180,1);margin-left: 0.9em;">Research Assistance</p>
        </div>
    <ul style="font-size: 15px; color: black;margin-left: 1.7em; font-family: 'Avenir Next LT Pro', sans-serif;">
...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: 10px;">
    <div class="main-content" style="flex: 1;">
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 5px;"> <p style="font-weight: bold; font-size: 21px; color: rgba(62,121,180,1); font-family: 'Garamond'; margin-left: .9em;"> Lab Instructor and Research Teacher</p>
        </div>
    <ul style="font-size: 15px;margin-left: 1.7em; color: black; font-family: 'Avenir Next LT Pro', sans-serif;">
...
<div class="textbox" style="display: flex;justify-content: space-between; line-height: 90px; margin-bottom: 10px;">
    <div class="main-content" style="flex: 1;">
    <div style="margin-left: 0.1em; margin-top: -0.1em; display: flex; align-items: center; margin-bottom: 5px;"> <p style="font-weight: bold; font-size: 21px; color: rgba(62,121,180,1); font-family: 'Garamond'; margin-left: .9em;"> Tutor</p>
        </div>
    <ul style="font-size: 15px; font-family: 'AvenirNext LT Pro Regular', sans-serif; margin-left: 1.7em; color: black;"> 
